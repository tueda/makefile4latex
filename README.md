...
[this link](https://raw.githubusercontent.com/tueda/makefile4latex/v0.3.2/Makefile)
in your browser or by using `curl`:
```shell
curl -O https://raw.githubusercontent.com/tueda/makefile4latex/v0.3.2/Makefile
```
