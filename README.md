...
[this link](https://raw.githubusercontent.com/tueda/makefile4latex/v0.4.1/Makefile)
in your browser or by using `curl`:
```shell
curl -O https://raw.githubusercontent.com/tueda/makefile4latex/v0.4.1/Makefile
```
